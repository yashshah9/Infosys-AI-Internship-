...
from tensorflow.keras.layers import Dense  # Import Dense layer type from Keras
...
# Input shape is 784 (28*28 pixels flattened)
...
model.save("Handwritten-digit-recognition-1\model\model1.h5")
